# Build Sky Wave ERP v2.0.1 Release
# Script to build and prepare release

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Building Sky Wave ERP v2.0.1" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path "installer_output\SkyWaveERP-Setup-2.0.1.exe") {
    Write-Host "  - Installer: installer_output\SkyWaveERP-Setup-2.0.1.exe" -ForegroundColor Cyan
}
Write-Host ""
Write-Host "Version: v2.0.1" -ForegroundColor Yellow
