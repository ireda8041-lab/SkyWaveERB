# Build Sky Wave ERP v2.1.4 Release
# Script to build and prepare release

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Building Sky Wave ERP v2.1.4" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path "installer_output\SkyWaveERP-Setup-2.1.4.exe") {
    Write-Host "  - Installer: installer_output\SkyWaveERP-Setup-2.1.4.exe" -ForegroundColor Cyan
}
Write-Host ""
Write-Host "Version: v2.1.4" -ForegroundColor Yellow
