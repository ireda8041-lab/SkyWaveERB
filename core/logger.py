...
def info(message: str, context: str | None = None):
    """تسجيل رسالة INFO"""
    logger = LoggerSetup.get_logger(context)
    logger.info(message)


def warning(message: str, context: str | None = None):
    """تسجيل رسالة WARNING"""
    logger = LoggerSetup.get_logger(context)
    logger.warning(message)


def error(message: str, context: str | None = None):
    """تسجيل رسالة ERROR"""
    logger = LoggerSetup.get_logger(context)
    logger.error(message)


def critical(message: str, context: str | None = None):
